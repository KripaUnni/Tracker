    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitStudentDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String email = studentParentEmail.getText().toString().trim();
                String pass = studentParentEmailPassword.getText().toString();
                ...
                studentModelForStudentDatabase =
                        new StudentModel(name, rollNo, address, city, state, country, picDrop,
                                parentName, parentContactNum, email, busRouteNum, busNumber);
