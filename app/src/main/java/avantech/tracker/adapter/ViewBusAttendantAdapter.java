...
public class ViewBusAttendantAdapter extends RecyclerView.Adapter<ViewBusAttendantAdapter.BusAttendantViewHolder> {
    ...
    @NonNull
    @Override
    public BusAttendantViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_bus_attendant_view,parent,false);
        return new BusAttendantViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BusAttendantViewHolder holder, int position) {
